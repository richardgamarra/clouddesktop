...
const POPULAR_APPS = [
  ...
  // Microsoft Office 365 — official Fluent UI CDN icons
  { name:'Outlook',          url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/outlook_96x1.png' },
  { name:'Word',             url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/word_96x1.png' },
  { name:'Excel',            url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/excel_96x1.png' },
  { name:'PowerPoint',       url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/powerpoint_96x1.png' },
  { name:'OneNote',          url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/onenote_96x1.png' },
  { name:'OneDrive',         url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/onedrive_96x1.png' },
  { name:'Teams',            url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/teams_96x1.png' },
  { name:'SharePoint',       url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/sharepoint_96x1.png' },
  { name:'Power BI',         url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/powerbi_96x1.png' },
  { name:'Power Apps',       url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/powerapps_96x1.png' },
  { name:'Power Automate',   url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/powerautomate_96x1.png' },
  { name:'Dynamics 365',     url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/dynamics_96x1.png' },
  { name:'Microsoft 365',    url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/office_96x1.png' },
  ...
  { name:'Azure DevOps',     url:'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/product/png/azure_96x1.png' },
  // Productivity
