...
const S = {
  nav: { display:'flex', alignItems:'center', padding:'0 48px', height:160, background:'rgba(11,13,18,.9)', borderBottom:'1px solid var(--border)', position:'sticky', top:0, zIndex:100, backdropFilter:'blur(12px)' },
  navLogo: { display:'flex', alignItems:'center', gap:10 },
  navLogoIcon: { height:144, width:'auto', display:'block' },
